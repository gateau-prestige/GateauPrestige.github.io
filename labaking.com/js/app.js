...
$("#breadBT").click(function(event) {
  $('html, body').animate({
      scrollTop: $("#pikola").offset().top
  }, 600);
  event.preventDefault();
});

$("#breakBT").click(function(event) {
  $('html, body').animate({
      scrollTop: $("#pikola").offset().top
  }, 600);
  event.preventDefault();
...
$("#dessertsBT").click(function(event) {
  $('html, body').animate({
      scrollTop: $("#pikola").offset().top
  }, 600);
  event.preventDefault();
...
function showBread() {
  document.getElementById('breadDiv').style.display = "block";
  document.getElementById('homeDiv').style.display = "none";
  document.getElementById('breakDiv').style.display = "none";
  document.getElementById('cakeDiv').style.display = "none";
  document.getElementById('dessertsDiv').style.display = "none";
}
function showBreak() {
  
  document.getElementById('breadDiv').style.display = "none";
  document.getElementById('homeDiv').style.display = "none";
...
function showDes() {
  ...
  document.getElementById('breakDiv').style.display = "none";
  document.getElementById('cakeDiv').style.display = "none";
  document.getElementById('dessertsDiv').style.display = "block";
}
function showCake() {
  document.getElementById('breadDiv').style.display = "none";
  document.getElementById('homeDiv').style.display = "none";
